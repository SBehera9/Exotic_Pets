...
const Navbar: React.FC = () => {
    ...
    return (
        <nav className="bg-green-100 shadow-md sticky top-0 z-50">
            <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8"> {/* Added sm:px-6 */}
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="-mr-2 flex md:hidden">
                        ...
                        >
                            <span className="sr-only">{mobileMenuOpen ? 'Close main menu' : 'Open main menu'}</span> {/* Improved accessibility */}
            ...
            <div className={`md:hidden ${mobileMenuOpen ? 'block' : 'hidden'}`}>
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3"> {/* Added sm:px-3 */}
